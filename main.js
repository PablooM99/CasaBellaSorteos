/* ==========================
   UTILIDADES DE UI (no dependen de Firebase)
   ========================== */
   ...
   /* Modal auth + modal participantes con fallback universal (<dialog>) */
   ...
   async function loginWithProvider(provider) {
     ...
     try {
       ...
       if (e?.code === "auth/popup-blocked" || e?.code === "auth/popup-closed-by-user") {
         ...
         if (res.isConfirmed) return signInWithRedirect(auth, provider);
         return;
       }
   ...
   /* ==========================
      FORMULARIO: registro (un usuario por sorteo)
      ========================== */
